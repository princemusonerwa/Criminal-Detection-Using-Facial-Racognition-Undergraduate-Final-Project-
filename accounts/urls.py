...
urlpatterns = [
    ...
    path('login', auth_views.LoginView.as_view(template_name="accounts/login.html", authentication_form=MyAuthenticationForm, redirect_authenticated_user=True), name="login"),
