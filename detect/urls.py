...
urlpatterns = [
    ...
    path('ajax/load-departments/', views.loadDepartments,
         name='ajax_load_departments'),
    ...
    path('crime/report', views.exportCrimeListPdf, name="crimes_report_pdf"),
    ...
    path('crime/under-inv-report',
         views.UnderInvestigationCrimesReport, name='under_inv_crimes'),
    path('crime/detected-criminals',
         views.DetectedCriminalReport, name='detected_criminals'),
    path('crime/download/underinv', views.downloadUnderInvestigation,
         name='download_under_inv'),
    path('crime/download/solved', views.downloadSolved,
         name='download_solved_crime'),
    path('crime/download/pending', views.downloadPending,
         name='download_pending_crime'),
    ...
    path('department/<int:id>/edit',
         views.updateDepartment, name='edit_department'),
    ...
    path('export-student-csv', views.exportStudentListCsv,
         name='export_student_csv'),
    path('export-student-excel', views.exportStudentListexcel,
         name='export_student_excel'),
    path('export-student-pdf', views.exportStudentListPdf,
         name='export_student_pdf'),
    path('export-employee-csv', views.exportEmployeeListCsv,
         name='export_employee_csv'),
    path('export-employee-excel', views.exportEmployeeListExcel,
         name='export_employee_excel'),
    path('export-employee-pdf', views.exportEmployeeListPdf,
